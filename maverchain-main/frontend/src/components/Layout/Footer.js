        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">Decentralized Healthcare</p>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/verify" className="text-gray-400 hover:text-white transition-colors">Drug Verification</a></li>
              <li><a href="/health-records" className="text-gray-400 hover:text-white transition-colors">Health Records</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><button className="text-gray-400 hover:text-white transition-colors">Whitepaper</button></li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
            <div className="flex items-center space-x-4 mb-2 md:mb-0">
              <div className="flex items-center space-x-2">
                ...
                <span>Blockchain Status: Online</span>
              </div>
              <div className="flex items-center space-x-2">
